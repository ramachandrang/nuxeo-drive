========================================================================
    ACTIVE TEMPLATE LIBRARY : CpoIconOverlay Project Overview
========================================================================

AppWizard has created this CpoIconOverlay project for you to use as the starting point for
writing your Dynamic Link Library (DLL).

This file contains a summary of what you will find in each of the files that
make up your project.

CpoIconOverlay.vcxproj
    This is the main project file for VC++ projects generated using an Application Wizard.
    It contains information about the version of Visual C++ that generated the file, and
    information about the platforms, configurations, and project features selected with the
    Application Wizard.

CpoIconOverlay.vcxproj.filters
...
CpoIconOverlay.idl
    ...
    This file will be processed by the MIDL compiler to generate:
        C++ interface definitions and GUID declarations (CpoIconOverlay.h)
        GUID definitions                                (CpoIconOverlay_i.c)
        A type library                                  (CpoIconOverlay.tlb)
        Marshaling code                                 (CpoIconOverlay_p.c and dlldata.c)

CpoIconOverlay.h
    This file contains the C++ interface definitions and GUID declarations of the
    items defined in CpoIconOverlay.idl. It will be regenerated by MIDL during compilation.
...
StdAfx.h, StdAfx.cpp
    ...
    named CpoIconOverlay.pch and a precompiled types file named StdAfx.obj.
...
CpoIconOverlayps.vcxproj
	...
	dlldata.c, CpoIconOverlay_i.c and CpoIconOverlay_p.c which are required
	to build the proxy/stub DLL.

CpoIconOverlayps.vcxproj.filters
