...
#        previous_time = time()
    ...
    def switch_offline(self, server_binding, exception, session = None, frontend = None):
        ...
        if code == 401 or code == 403:
            ...
            try:
                ...
                if code == 401 or code == 403:
                    if frontend is not None:
                        frontend.notify_offline(folder, exception)
                # return true to indicate that sync should stop
                return True
        else:
            return True
