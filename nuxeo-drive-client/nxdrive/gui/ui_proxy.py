...
#        grid.addWidget(self.buttonBox, 6, 0, 1, 4, QtCore.Qt.AlignRight)
        ...
        grid.addWidget(self.line, 1, 0, 1, 4)
        grid.addWidget(self.cbAuthN, 2, 1, 1, 1)
        grid.addWidget(self.lblUser, 3, 0, 1, 1)
        grid.addWidget(self.txtUser, 3, 1, 1, 1)
        grid.addWidget(self.lblPwd, 4, 0, 1, 1)
        grid.addWidget(self.txtPwd, 4, 1, 1, 1)
        grid.addWidget(self.buttonBox, 5, 0, 1, 4, QtCore.Qt.AlignRight)
