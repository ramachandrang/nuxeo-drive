...
#        gridLayout.addWidget(self.txtPwd, 2, 1, 1, 1)
        gridLayout.addWidget(self.lblUser, 0, 0, 1, 1)
        gridLayout.addWidget(self.txtUser, 0, 1, 1, 1)
        gridLayout.addWidget(self.lblPwd, 1, 0, 1, 1)
        gridLayout.addWidget(self.txtPwd, 1, 1, 1, 1)
